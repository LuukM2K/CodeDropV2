    ...
    <div class="main-container">
        ...
        <div class="main-header">
            <div class="main-content">
                <img class="header-img" src="images/codedrop-logo.png" width="65" height="65">
                    ...
                    <div class="column" style="margin-bottom: 25px;">
                        <div class="ui card" style="background-color: #1e1e1e">
                            ...
                            <div class="content">
                                ...
                                <div class="description" style="color: #e1e1e1">
                                    €15
                                </div>
                            </div>
                            <div class="extra content">
                                <button data-shoppy-product="RZzxsNy" class="fluid ui button"
                                        style="background-color: #FF4181; color: #e1e1e1">Pay
                                </button>
                            </div>
                        </div>
                    </div>
