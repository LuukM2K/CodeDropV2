                ...
                <div class="row">
                    ...
                    <div class="column">
                        <div class="ui card" style="background-color: #1e1e1e">
                            ...
                            <div class="content">
                                <a class="header" style="color: #e1e1e1">Glow Skin + emote</a>
                                <div class="description" style="color: #e1e1e1;font-size: 22px;">
                                    €6,99
                                </div>
                            </div>
                    ...
                    <div class="column">
                        <div class="ui card" style="background-color: #1e1e1e">
                            ...
                            <div class="content">
                                <a class="header" style="color: #e1e1e1">HONOR OUTFIT Code</a>
                                <div class="description" style="color: #e1e1e1;font-size: 22px;">
                                    €19,99
                                </div>
                            </div>
                    ...
                    <div class="column" style="margin-bottom: 25px;">
                        <div class="ui card" style="background-color: #1e1e1e">
                            ...
                            <div class="content">
                                <a class="header" style="color: #e1e1e1">Big Eon skin + 2000 Vbucks</a>
                                <div class="description" style="color: #e1e1e1;font-size: 22px;">
                                    €59,99
                                </div>
                            </div>
                    ...
                    <div class="column" style="margin-bottom: 25px;">
                        <div class="ui card" style="background-color: #1e1e1e">
                            <div class="image">
                                <img src="images/psycho.png"/>
                            </div>
                            <div class="content">
                                <a class="header" style="color: #e1e1e1">PSYCHO BUNDLE Code</a>
                                <div class="description" style="color: #e1e1e1;font-size: 22px;">
                                    €23.99
                                </div>
                            </div>
