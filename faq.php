    ...
    <div class="main-container">
        ...
        <div class="container">
            ...
            <div class="acc">
                ...
                <div class="content">
                    <div class="content-inner">
                        <p>No Refunds / No Replacements since all codes are checked before sending out. For products
                            which require account login information we also will not provide any refunds since we apply
                            the product to the account which you give us in order details.</p>
                    </div>
                </div>
            </div>
        </div>
